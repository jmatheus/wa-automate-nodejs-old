        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 38:
                    ...
                    if (!(config === null || config === void 0 ? void 0 : config.licenseKey)) return [3, 41];
                    if (!!axios) return [3, 40];
                    return [4, Promise.resolve().then(function () { return __importStar(require('axios')); })];
                case 39:
                    axios = _d.sent();
                    _d.label = 40;
