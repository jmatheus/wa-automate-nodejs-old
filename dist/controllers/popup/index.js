...
var http = require('http'), io, express = require('express'), app = express(), open = require('open'), getPort = require('get-port'), url = require('url'), content = require('fs').readFileSync(__dirname + '/index.html', 'utf8'), gClient, PORT, server, currentQrCodes = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, open("http://localhost:" + PORT, { app: ['google chrome', '--incognito'], allowNonzeroExitCode: true }).catch(function () { })];
                case 2:
                    _a.sent();
                    return [3, 4];
                case 3: return [2, "NA"];
